...
<section class="section-6">
        <div class="modal fade" id="terminos-modal" tabindex="-1" role="dialog" aria-labelledby="terminos-modal" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="section__title">
                            <h2 class="section__text-title">TÉRMINOS DE SERVICIO</h2>
                        </div>

                        <hr class="section__divider">

                        <div class="section__subtitle">
                            <p class="section__text-subtitle">INFORMACIÓN GENERAL</p>
                            
                        </div>

                        <div class="section__textctr">
                            <p>
                            Este sitio web es operado por TECSANplus+. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a TECSANplus+. TECSANplus+ ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
                        ...
                        <div class="section__subtitle">
                            <p class="section__text-subtitle">SECCIÓN 1 - TÉRMINOS DE LA TIENDA EN LÍNEA</p>
                        </div>
                        ...
                        <div class="section__subtitle">
                            <p class="section__text-subtitle">SECCIÓN 2 - CONDICIONES GENERALES</p>
                        </div>
                        ...
                        <div class="section__subtitle">
                            <p class="section__text-subtitle">SECCIÓN 3 - EXACTITUD, EXHAUSTVIDAD Y ACTUALIDAD DE LA INFORMACIÓN</p>
                        </div>
                        ...
                        <div class="section__subtitle">
                            <p class="section__text-subtitle">SECTION 4 - MODIFICACIONES AL SERVICIO Y PRECIOS</p>
                        </div>
                        ...
                        <div class="section__subtitle">
                            <p class="section__text-subtitle">SECCIÓN 5 - PRODUCTOS O SERVICIOS (si aplicable)</p>
                        </div>
                        ...
                        <div class="section__textctr">
                            <p>
                                ...
                                No garantizamos que la calidad de los productos, servicios, información u otro material comprado u obtenido por ti  cumpla con tus expectativas, o que cualquier error en el
                                Servicio será corregido.
                            </p>
                        </div>

                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 6 - EXACTITUD DE FACTURACIÓN E INFORMACIÓN DE CUENTA</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 7 - HERRAMIENTAS OPCIONALES</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 8 - ENLACES DE TERCERAS PARTES</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 9 - COMENTARIOS DE USUARIO, CAPTACIÓN Y OTROS ENVÍOS</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 10 - INFORMACIÓN PERSONAL</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 11 - ERRORES, INEXACTITUDES Y OMISIONES</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 12 - USOS PROHIBIDOS</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 13 - EXCLUSIÓN DE GARANTÍAS; LIMITACIÓN DE RESPONSABILIDAD</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            <p>
                                ...
                                En ningún caso TECSANplus+, nuestros directores, funcionarios, empleados, afiliados, agentes, contratistas, internos, proveedores, prestadores de servicios o licenciantes serán responsables por cualquier daño, pérdida, reclamo, o daños directos, indirectos, incidentales, punitivos, especiales o consecuentes de cualquier tipo, incluyendo, sin limitación, pérdida de beneficios, pérdida de igresos, pérdida de ahorros, pérdida de datos, costos de reemplazo, o cualquier daño similar, ya sea basado en contrato, agravio (incluyendo negligencia), responsabilidad estricta o de otra manera, como consecuencia del uso de cualquiera de los servicios o productos adquiridos mediante el servicio, o por cualquier otro reclamo relacionado de alguna manera con el uso del servicio o cualquier producto, incluyendo pero no limitado, a cualquier error u omisión en cualquier contenido, o cualquier pérdida o daño de cualquier tipo incurridos como resultados de la utilización del servicio o cualquier contenido (o producto) publicado, transmitido, o que se pongan a disposición a través del servicio, incluso si se avisa de su posibilidad.  Debido a que algunos estados o jurisdicciones no permiten la exclusión o la limitación de responsabilidad por daños consecuenciales o incidentales, en tales estados o jurisdicciones, nuestra responsabilidad se limitará en la medida máxima permitida por la ley.
                            </p>
                        </div>

                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 14 - INDEMNIZACIÓN</p>
                            </div>
                            
                        <div class="section__textctr">
                            <p>Aceptas indemnizar, defender y mantener indemne TECSANplus+ y nuestras matrices, subsidiarias, afiliados, socios, funcionarios, directores, agentes, contratistas, concesionarios, proveedores de servicios, subcontratistas, proveedores, internos y empleados, de cualquier reclamo o demanda, incluyendo honorarios razonables de abogados, hechos por cualquier tercero a causa o como resultado de tu incumplimiento de las Condiciones de Servicio o de los documentos que incorporan como referencia, o la violación de cualquier ley o de los derechos de u tercero.</p>
                        </div>

                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 15 - DIVISIBILIDAD</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 16 - RESCISIÓN</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 17 - ACUERDO COMPLETO</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 18 - LEY</p>
                            </div>
                            
                        <div class="section__textctr">
                            <p>Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Sur 103 No. 402 Local "A", Ciudad de México, DIF, 09090, Mexico.</p>
                        </div>

                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 19 - CAMBIOS EN LOS TÉRMINOS DE SERVICIO</p>
                            </div>
                        ...
                        <div class="section__textctr">
                            ...
                            <div class="section__subtitle">
                                <p class="section__text-subtitle">SECCIÓN 20 - INFORMACIÓN DE CONTACTO</p>
                            </div>
                            
                        <div class="section__textctr">
                            <p>Preguntas acerca de los Términos de Servicio deben ser enviadas a vargasweb@outlook.com.</p>
                        </div>
